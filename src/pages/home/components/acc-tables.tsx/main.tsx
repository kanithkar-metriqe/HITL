...
const data = [
  {
    ...
    title: (
      <Title
        intent="h4"
        className="bg-orange-150 w-full text-orange-880 py-4 px-3 rounded-tl-md cursor-pointer"
      >
        Gl Table
      </Title>
    ),
    content: <GlTable />,
    borderClass:
      "border-2 border-orange-850 border-b-0 rounded-bl-none rounded-br-none hover:no-underline",
...

  {
    ...
    title: (
      <Title
        intent="h4"
        className="bg-mt-blue-110 w-full text-mt-blue-880 py-4 px-3 rounded-none cursor-pointer"
      >
        PMS Details
      </Title>
    ),
  ...
  },
  {
    ...
    title: (
      <Title
        intent="h4"
        className="bg-mt-green-100 w-full text-mt-green-880 py-4 px-3 roundeed-none no-underline cursor-pointer"
      >
        Merchant Details
      </Title>
    ),
    ...
    borderClass:
      "border-mt-green-880 border-2 border-t-0 rounded-tl-none rounded-tr-none [&[data-state=open]]:rounded-none hover:no-underline",
...
export default function Analysis() {
  return (
    <div className="py-5">
      <Title intent="h6" className="border-b pb-1 font-semibold">
        BR Agentic Intelligent Analysis
      </Title>
